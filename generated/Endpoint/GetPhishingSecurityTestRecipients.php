...
class GetPhishingSecurityTestRecipients extends \KnowBe4\Kmsat\Api\Runtime\Client\BaseEndpoint implements \KnowBe4\Kmsat\Api\Runtime\Client\Endpoint
{
    protected $id;
    /**
     * 
    ...
    {
        return str_replace(array('{id}'), array($this->id), '/v1/phishing/security_tests/{id}/recipients');
    }
